    ...
    <section className="relative z-10 max-w-6xl mx-auto px-6 pt-24 min-h-screen">
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          {/* Heading */}
          <h1 className="text-4xl md:text-7xl sm:text-2xl font-light leading-tight tracking-tight text-zinc-900 max-w-3xl">
            Inclusive Financial Layer 1 for Real Value and Institutional-Grade Assets
          </h1>
        ...
        <div className="hidden lg:flex justify-center items-center">
          <div className="w-40 h-40 bg-blue-600 rounded-sm shadow-2xl animate-pulse"></div>
        </div>
