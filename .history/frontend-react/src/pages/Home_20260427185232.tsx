    ...
    <section className="relative z-10 max-w-6xl mx-auto px-6 pt-24 min-h-screen">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
                ...
                <h1 className="text-4xl md:text-7xl font-light leading-tight tracking-tight text-zinc-00 max-w-3xl">Inclusive Financial Layer 1 for Real Value and Institutional-Grade Assets</h1>
            </div>
        </div>
    </section>
  );
