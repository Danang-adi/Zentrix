...
export default function Home() {
  return (
    <section className="relative z-10 max-w-6xl mx-auto px-6 pt-40 min-h-screen">
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          {/* Button */}
          <div className="mt-10">
            <button <a href="https://discord.gg/9ujhx8av"></a> className="flex items-center gap-3 bg-white shadow-md hover:shadow-lg px-5 py-3 rounded-xl transition">
