...
<div ref={scrollRef} className="overflow-hidden">
  <motion.div
    ...
    dragElastic={0.1}
    className="flex gap-6 cursor-grab active:cursor-grabbing pr-24"
  >
    {blogs.map((item, index) => (
      <div
        key={index}
        className="min-w-[500px] bg-white text-black rounded-2xl overflow-hidden shadow-lg hover:scale-[1.03] transition cursor-pointer"
      >
