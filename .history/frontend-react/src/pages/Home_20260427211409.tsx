...
export default function Home() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <div className="mt-20 max-w-xl border-l-2 border-zinc-700 pl-6 text-zinc-700 leading-relaxed">
              Powered by modular architecture, deep-parallel execution, and built-in compliance.
            </div>
          </div>
          ...
          <div className="hidden lg:flex justify-center items-center">
            <img
              src={HomeGif}
              alt="Hero Animation"
              className="w-[550px] rounded-2xl shadow-2xl translate-x-14 -translate-y-10"
            />
          </div>
